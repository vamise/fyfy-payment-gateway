...
/**
 * WC_FyfyPay_Rates class.
 *
 */
class WC_FyfyPay_Rates {

	// A map between currency symbols and CoinMarketCap IDs
	const CMC_FIAT_IDS = array(
		'USD' => 2781,
		'AUD' => 2782,
		'BRL' => 2783,
		'CAD' => 2784,
	 ...
	 * @return float
	 */
	public static function convert_currency_amount( $currency_symbol, $currency_amount, $token_symbol ) {
